...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'blood_request.create': {
    ...
    key: 'blood-request-created',
    tenantPath: ['hospital', 'blood_request'],
    userPath: [],
  },
  'blood_request.update': {
    roles: ['admin', 'staff-member'],
    key: 'blood-request-status-updated',
    tenantPath: ['hospital', 'blood_request'],
    userPath: [],
  },
  'blood_bank.update': {
    roles: ['admin', 'staff-member'],
    key: 'blood-bank-inventory-updated',
    tenantPath: ['hospital', 'blood_bank'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['admin', 'staff-member'];
