...
import { getBloodRequestById } from 'apiSdk/blood-requests';
import { BloodRequestInterface } from 'interfaces/blood-request';

function BloodRequestViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('blood_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/blood-requests/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Requester Name" text={data?.requester_name} />

                <FormListItem label="Blood Type" text={data?.blood_type} />
