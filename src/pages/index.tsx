  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Findblood, your reliable partner in finding crucial blood supplies for patients nearby. Your life-saving connection starts here."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1606206522398-de3bd05b1615?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxibG9vZCUyMGJhbmt8ZW58MHx8fHwxNjk0MTA4NDgzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Findblood, your reliable partner in finding crucial blood supplies for patients nearby. Your life-saving connection starts here.`}
            </Text>
            <Box
